...
{#if data.authorised}
    ...
    >
        <div class="flex items-center justify-center mt-5">
            ...
            >
                ...
                >
                    Enter the email id whose payment status you want to check
                </div>
    ...
    >
        {#if form?.success}
            {#each form.foundPayments as foundPayment, i}
                <div
                ...
                >
                    <div
                        class="w-[100%] h-full bg-[#1C1337] h-[300px] border-[1px] mt-10 rounded-xl flex flex-col items-center justify-center shadow-[5px_5px_0px_0px_rgba(239,247,207,1)]"
                    >
                        <!-- <p
                    ...
                    <div
                        class="bg-[#1C1337] h-[200px] w-[80%] rounded-bl-xl rounded-br-xl border-[1px] border-solid flex flex-col items-center justify-center shadow-[5px_5px_0px_0px_rgba(239,247,207,1)]"
                    >
                        <p
                            class="text-[#EFF7CF] font-yatra text-2xl font-bold tracking-widest text-center"
                        >
                            ₹{foundPayment.amount / 100}
                        </p>
                        <p
                            class="text-[#EFF7CF] font-yatra text-lg font-bolder tracking-wider text-center"
                        >
                            {foundPayment.status}
                        </p>
                    </div>
